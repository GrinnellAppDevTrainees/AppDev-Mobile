...
public class AlumniFragment extends ListFragment {
    ...
    ImageLoader.getInstance().init(config);
		...
		mProgressBar = (ProgressBar) rootView.findViewById(R.id.alumniProgressBar);
	...
	public void onListItemClick(ListView l, View v, int position, long id) {
		...
		try {
			jsonMembers = mMemberData.getJSONArray("alumni");
			...
			homepageurl = jsonMember.getString("homepageurl");
